...
extern NSString * NGSPercentEscapedStringFromString(NSString *string);

extern NSString * const kNGSApplicationJSONType;

@protocol NGSSanitizer <NSObject>
...
@interface NGSSanitizer : NSObject <NGSSanitizer>
