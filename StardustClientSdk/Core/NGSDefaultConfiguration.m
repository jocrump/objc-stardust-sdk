#import "NGSDefaultConfiguration.h"
#import "NGSBasicAuthTokenProvider.h"
#import "NGSLogger.h"

@interface NGSDefaultConfiguration ()
...
@implementation NGSDefaultConfiguration

#pragma mark - Singleton Methods

+ (instancetype) sharedConfig {
    static NGSDefaultConfiguration *shardConfig = nil;
...
- (instancetype) init {
    self = [super init];
    if (self) {
        _host = @"https://sandboxdreadnought.ngsdevapps.net";
        _username = @"";
        _password = @"";
        _accessToken= @"";
        _verifySSL = YES;
        ...
        _logger = [NGSLogger sharedLogger];
    }
    return self;
}
...
- (NSString *) getBasicAuthToken {
    ...
    NSString *basicAuthToken = [NGSBasicAuthTokenProvider createBasicAuthTokenWithUsername:self.username password:self.password];
