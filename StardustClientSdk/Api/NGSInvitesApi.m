...
///
///  @returns NSArray<NGSInviteParticipantResponse>*
///
-(NSURLSessionTask*) deleteParticipantInviteWithApplicationName: (NSString*) applicationName
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/stardust/v1/applications/{applicationName}/invites/participant"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"NSArray<NGSInviteParticipantResponse>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<NGSInviteParticipantResponse>*)data, error);
                                }
                            }];
}
...
-(NSURLSessionTask*) getInviteRecipientsByResourcePathWithAppName: (NSString*) appName
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/api/stardust/v1/applications/{applicationName}/invites/resources/{appName}/{resourceType}/{identifier}/recipients"];

    NSMutableDictionary *pathParams = [[NSMutableDictionary alloc] init];
    if (appName != nil) {
        pathParams[@"appName"] = appName;
    }
    if (resourceType != nil) {
